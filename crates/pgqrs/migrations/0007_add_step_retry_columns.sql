...
CREATE INDEX idx_pgqrs_workflow_steps_retry_at
...
COMMENT ON COLUMN pgqrs_workflow_steps.retry_at IS 'Scheduled time for next retry attempt (NULL if not scheduled)';
