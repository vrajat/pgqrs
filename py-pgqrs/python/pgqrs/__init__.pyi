...
class Config:
    ...
    @max_payload_size_bytes.setter
    def max_payload_size_bytes(self, value: int) -> None: ...
    @property
    def max_string_length(self) -> int: ...
    @max_string_length.setter
    def max_string_length(self, value: int) -> None: ...
    @property
    def max_object_depth(self) -> int: ...
    @max_object_depth.setter
    def max_object_depth(self, value: int) -> None: ...
    @property
    def forbidden_keys(self) -> List[str]: ...
    @forbidden_keys.setter
    def forbidden_keys(self, value: List[str]) -> None: ...
    @property
    def required_keys(self) -> List[str]: ...
    @required_keys.setter
    def required_keys(self, value: List[str]) -> None: ...
    @property
    def max_enqueue_per_second(self) -> Optional[int]: ...
    @max_enqueue_per_second.setter
    def max_enqueue_per_second(self, value: Optional[int]) -> None: ...
    @property
    def max_enqueue_burst(self) -> Optional[int]: ...
    @max_enqueue_burst.setter
    def max_enqueue_burst(self, value: Optional[int]) -> None: ...
    @property
    def s3_mode(self) -> DurabilityMode: ...
    @s3_mode.setter
    def s3_mode(self, value: DurabilityMode) -> None: ...
    @property
    def s3_cache_dir(self) -> str: ...
    @s3_cache_dir.setter
    def s3_cache_dir(self, value: str) -> None: ...
...
class Store:
    ...
    async def queue(self, name: str) -> "QueueInfo": ...
    async def get_workers(self) -> "Workers": ...
    async def get_queues(self) -> "Queues": ...
    async def get_messages(self) -> "Messages": ...
    async def get_workflows(self) -> "Workflows": ...
    async def get_workflow_runs(self) -> "WorkflowRuns": ...
    async def get_workflow_steps(self) -> "WorkflowSteps": ...
...
class Consumer:
    ...
    async def dequeue_many_with_delay(
        self, limit: int, vt: int
    ) -> List["QueueMessage"]: ...
    async def dequeue_at(
        self, limit: int, vt: int, current_time: str
    ) -> List["QueueMessage"]: ...
    async def extend_vt(self, message_id: int, seconds: int) -> bool: ...
    async def archive(self, message_id: int) -> bool: ...
    async def archive_many(self, message_ids: List[int]) -> List[bool]: ...
    async def delete(self, message_id: int) -> bool: ...
    async def delete_many(self, message_ids: List[int]) -> List[bool]: ...
    async def release_with_visibility(
        self, message_id: int, visible_at: str
    ) -> bool: ...
    async def release_messages(self, message_ids: List[int]) -> int: ...
...
class StepRecord:
    ...
    def error(self) -> Optional[Any]: ...
    @property
    def retry_at(self) -> Optional[str]: ...
    @property
    def created_at(self) -> str: ...
    @property
    def updated_at(self) -> str: ...
...
class Workflows:
    async def get_by_name(self, name: str) -> WorkflowRecord: ...

class WorkflowRuns:
    async def list(self) -> List[RunRecord]: ...

class WorkflowSteps:
    async def list(self) -> List[StepRecord]: ...

class Workers:
    async def count(self) -> int: ...
    async def list(self) -> List[WorkerInfo]: ...
    async def get(self, worker_id: int) -> WorkerInfo: ...
...
class Messages:
    async def count(self) -> int: ...
    async def list_archived_by_queue(self, queue_id: int) -> List[QueueMessage]: ...
...
class Admin:
    ...
    async def release_worker_messages(self, worker_id: int) -> int: ...
    async def create_workflow(self, name: str, arg: Any) -> "Run": ...

class Run:
    def id(self) -> int: ...
    @property
    def current_time(self) -> Optional[str]: ...
    def with_time(self, time: str) -> "Run": ...
    async def start(self) -> None: ...
    async def fail(self, error: str) -> None: ...
    async def success(self, result: Any) -> None: ...
    async def complete(self, result: Any) -> None: ...
    async def refresh(self) -> "Run": ...
    async def pause(self, message: str, resume_after_seconds: int) -> None: ...
    async def acquire_step(
        ...
        Returns:
            StepResult with status and optional guard
...
class StepResult:
    ...
    def value(self) -> Any: ...
    @property
    def guard(self) -> Optional["StepGuard"]: ...
...
def as_s3(store: Store) -> S3StoreHandle: ...
...
def run() -> "RunBuilder": ...
def step() -> "StepBuilder": ...

class WorkflowBuilder:
    def name(self, name: str) -> "WorkflowBuilder": ...
    def store(self, store: Store) -> "WorkflowBuilder": ...
    def id(self, id: int) -> "WorkflowBuilder": ...
    async def create(self) -> WorkflowRecord: ...
    def trigger(self, input: Any) -> "WorkflowTriggerBuilder": ...

class WorkflowTriggerBuilder:
    async def execute(self) -> QueueMessage: ...

class RunBuilder:
    def message(self, message: QueueMessage) -> "RunBuilder": ...
    def store(self, store: Store) -> "RunBuilder": ...
    async def execute(self) -> Run: ...
    async def result(self) -> Any: ...
    async def get(self) -> Optional[Any]: ...

class StepBuilder:
    def run(self, run: Run) -> "StepBuilder": ...
    def name(self, name: str) -> "StepBuilder": ...
    def id(self, id: str) -> "StepBuilder": ...
    def with_time(self, time: str) -> "StepBuilder": ...
