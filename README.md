...
* **[Installation Guide](docs/user-guide/getting-started/installation.md)** - Setup the coordinator and workers
* **[Quickstart](docs/user-guide/getting-started/quickstart.md)** - Write and run your first workflow in 5 minutes
* **[Durable Workflows Guide](docs/user-guide/guides/durable-workflows.md)** - Deep dive on workflow behavior, retries, and errors
